...
public class PlaysaveState extends GameState {
	...
	public PlaysaveState(GameStateManager gsm,Game game) {
		super(gsm);
		this.game = game;
		init(game);
		init();
	...
	public void init (Game game) {
		...
		player = new Player(tm,game);
		player.setTilePosition(game.detachedTwo(game.getRowcol())[0], game.detachedTwo(game.getRowcol())[1]);
	...
	public void input() {
		if (KeyHandle.isPressed(KeyHandle.PAUSE)) {
			...
			GameStateManager.pauseState.init(game);
		}	
